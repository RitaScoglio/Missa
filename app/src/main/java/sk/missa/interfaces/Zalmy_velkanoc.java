...
public interface Zalmy_velkanoc {
    ...
    String[][] velkanocAleluja = {
            ...
            {"21", "1", "", "Kol 3, 1", "<font color='#B71C1C'>R.</font> Aleluja. <font color='#B71C1C'>–</font> Ak ste s Kristom vstali z mŕtvych, hľadajte, čo je hore, kde Kristus sedí po pravici Boha! <font color='#B71C1C'>– R.</font> Aleluja."},
            {"22", "2", "", "Jn 3, 14b-15", "<font color='#B71C1C'>R.</font> Aleluja. <font color='#B71C1C'>–</font> Syn človeka musí byť vyzdvihnutý, aby každý, kto verí, mal v ňom večný život. <font color='#B71C1C'>– R.</font> Aleluja."},
