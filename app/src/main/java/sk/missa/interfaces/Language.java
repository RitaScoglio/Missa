...
public interface Language {
    ...
    String[][] Latin_vypis = {
            ...
            {"Benedictus Deus in saecula.", "Požehnaný Boh naveky!"},
            ...
            {"Grátias agámus Dómino Deo nostro.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
            ...
            {"Amen."},
            {"Ite, missa est.", "Choďte v mene Božom."},
            {"Deo gratias.", "Bohu vďaka."}
    };
    ...
    String[][] Italy_vypis = {
            ...
            {"Benedetto sei tu, Signore, Dio dell'universo: dalla tua bontà abbiamo ricevuto questo pane, frutto della terra e del lavoro dell'uomo; lo presentiamo a te, perché diventi per noi cibo di vita eterna.",
                    "Požehnaný si, Pane, Bože všetkého stvorenia, pretože sme z tvojej štedrosti prijali tento chlieb. Obetujeme ti ho ako plod zeme a práce ľudských rúk, aby sa nám stal chlebom života."},
            {"Benedetto nei secoli il Signore.", "Požehnaný Boh naveky!"},
            ...
            {"Rendiamo grazie al Signore, nostro Dio.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
        ...
        "Nech vás žehná všemohúci Boh, Otec i Syn † i Duch Svätý."},
        {"Amen."},
        {"Andate in pace.", "Choďte v mene Božom."},
        {"Rendiamo grazie a Dio.", "Bohu vďaka."}
        };
    ...
    String[][] Croatia_vypis = {
            ...
            {"Blagoslovljen si, Gospodine, Bože svega svijeta: od tvoje darežljivosti primismo kruh što ti ga prinosimo; ovaj plod zemlje i rada ruku čovječjih postat će nam kruhom života.",
                    "Požehnaný si, Pane, Bože všetkého stvorenia, pretože sme z tvojej štedrosti prijali tento chlieb. Obetujeme ti ho ako plod zeme a práce ľudských rúk, aby sa nám stal chlebom života."},
            {"Blagoslovljen Bog u vijeke!", "Požehnaný Boh naveky!"},
            ...
            {"Hvalu dajmo Gospodinu Bogu našemu.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
            ...
            {"Blagoslovio vas Svemogući Bog, Otac i Sin i <font color='#B71C1C'>†</font> Duh Sveti.",
                    "Nech vás žehná všemohúci Boh, Otec i Syn † i Duch Svätý."},
            {"Amen."},
            {"Idite u miru.", "Choďte v mene Božom."},
            {"Bogu hvala.", "Bohu vďaka."}
    };
    ...
    String[][] Polish_vypis = {
            ...
            {"Błogosławiony jesteś, Panie, Boże wszechświata, bo dzięki Twojej hojności otrzymaliśmy chleb, który jest owocem ziemi i pracy rąk ludzkich; Tobie go przynosimy, aby stał się dla nas chlebem życia.",
                    "Požehnaný si, Pane, Bože všetkého stvorenia, pretože sme z tvojej štedrosti prijali tento chlieb. Obetujeme ti ho ako plod zeme a práce ľudských rúk, aby sa nám stal chlebom života."},
            {"Błogosławiony jesteś, Boże, teraz i na wieki.", "Požehnaný Boh naveky!"},
            ...
            {"Dzięki składajmy Panu Bogu naszemu.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
            ...
            {"Niech was błogosławi Bóg wszechmogący, Ojciec i Syn, <font color='#B71C1C'>†</font> i Duch Święty.",
                    "Nech vás žehná všemohúci Boh, Otec i Syn † i Duch Svätý."},
            {"Amen."},
            {"Idźcie w pokoju Chrystusa.", "Choďte v mene Božom."},
            {"Bogu niech będą dzięki.", "Bohu vďaka."},
            //Bonusove časti
    ...
    String[][] Hungary_vypis = {
            ...
            {"Áldott vagy, Urunk, mindenség Istene, mert a te bőkezűségedből kaptuk a kenyeret. Felajánljuk neked, mint a föld termését és az emberi munka gyümölcsét. Ebből lesz számunkra az élet kenyere.",
                    "Požehnaný si, Pane, Bože všetkého stvorenia, pretože sme z tvojej štedrosti prijali tento chlieb. Obetujeme ti ho ako plod zeme a práce ľudských rúk, aby sa nám stal chlebom života."},
            {"Áldott legyen az Isten mindörökké.", "Požehnaný Boh naveky!"},
            ...
            {"Adjunk hálát Urunknak, Istenünknek.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
            ...
            {"Áldjon meg benneteket a mindenható Isten: az Atya, a Fiú <font color='#B71C1C'>†</font> és a zentlélek.",
                    "Nech vás žehná všemohúci Boh, Otec i Syn † i Duch Svätý."},
            {"Amen."},
            {"A szentmise véget ért, menjetek békével!", "Choďte v mene Božom."},
            {"Istennek legyen hála.", "Bohu vďaka."},
    ...
    String[][] German_vypis = {
            ...
            {"Gepriesen bist du, Herr, unser Gott, Schöpfer der Welt. Du schenkst uns das Brot, die Frucht der Erde und der menschlichen Arbeit. Wir bringen dieses Brot vor dein Angesicht, damit es uns das Brot des Lebens werde.",
                    "Požehnaný si, Pane, Bože všetkého stvorenia, pretože sme z tvojej štedrosti prijali tento chlieb. Obetujeme ti ho ako plod zeme a práce ľudských rúk, aby sa nám stal chlebom života."},
            {"Gepriesen bist du in Ewigkeit, Herr, unser Gott.", "Požehnaný Boh naveky!"},
            ...
            {"Lasset uns danken dem Herrn, unserm Gott.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
            ...
            {"Es segne Euch der allmächtige Gott, der Vater, der Sohn <font color='#B71C1C'>†</font> und der Heilige Geist.",
                    "Nech vás žehná všemohúci Boh, Otec i Syn † i Duch Svätý."},
            {"Amen."},
            {"Gehet hin in Frieden.", "Choďte v mene Božom."},
    ...
    String[][] Spain_vypis = {
            ...
            {"Bendito seas, Señor, Dios del universo, por este pan, fruto de la tierra y del trabajo del hombre, que recibimos de tu generosidad y ahora te presentamos; él será para nosotros pan de vida.",
                    "Požehnaný si, Pane, Bože všetkého stvorenia, pretože sme z tvojej štedrosti prijali tento chlieb. Obetujeme ti ho ako plod zeme a práce ľudských rúk, aby sa nám stal chlebom života."},
            {"Bendito seas por siempre, Señor.", "Požehnaný Boh naveky!"},
            ...
            {"Demos gracias al Señor, nuestro Dios.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
            ...
            {"La bendición de Dios todopoderoso, Padre, <font color='#B71C1C'>†</font> Hijo y Espíritu Santo, descienda sobre vosotros.",
                    "Nech vás žehná všemohúci Boh, Otec i Syn † i Duch Svätý."},
            {"Amén."},
            {"Podéis ir en paz.", "Choďte v mene Božom."},
    ...
    String[][] French_vypis = {
            ...
            {"Rendons grâce au Seigneur notre Dieu.", "Vzdávajme vďaky Pánovi, nášmu Bohu."},
    ...
    String[][] English_vypis = {
            ...
            {"Blessed are you, Lord God of all creation,\n" +
                    ...
                    "Požehnaný si, Pane, Bože všetkého stvorenia, pretože sme z tvojej štedrosti prijali tento chlieb. Obetujeme ti ho ako plod zeme a práce ľudských rúk, aby sa nám stal chlebom života."},
            {"Blessed be God for ever.", "Požehnaný Boh naveky!"},
            {"Blessed are you, Lord God of all creation,\n" +
                    "for through your goodness we have received\n" +
            ...
            {"May almighty God bless you, the Father, and the Son, <font color='#B71C1C'>†</font> and the Holy Spirit.",
                    "Nech vás žehná všemohúci Boh, Otec i Syn † i Duch Svätý."},
            {"Amen."},
            {"Go forth, the Mass is ended. Go and announce the Gospel of the Lord. Go in peace, glorifying the Lord by your life. Go in peace.", "Choďte v mene Božom."},
            {"Thanks be to God.", "Bohu vďaka."},
            //Bonusove časti
            {"The mystery of faith.", "Hľa tajomstvo viery."},
            {"The mystery of faith.", "Hľa tajomstvo viery."},
